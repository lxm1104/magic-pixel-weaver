  ...
  return (
    <div 
      className={cn(
        ...
        selected ? "ring-4 ring-primary/50 scale-[0.98]" : "hover:scale-[1.02]",
    ...
    >
      ...
      />
      {selected && (
        <div className="absolute top-2 right-2 w-6 h-6 bg-primary/90 backdrop-blur-sm rounded-full flex items-center justify-center text-white text-xs shadow-lg">
